...
if __name__ == "__main__":
    print(f"Test case 1: {check(square(9), 81)} [square()]")
    sleep(1.5)
    print(f"Test case 2: {check(square(-1345134354685), 1809386432153831381449225)} [square()]")
    sleep(1.5)
    print(f"Test case 3: {check(cube(0), 0)} [cube()]")
    sleep(1.5)
    print(f"Test case 4: {check(cube(-73454), -396320330980664)} [cube()]")
    sleep(1.5)
    print(f"Test case 5: {check(reverse('hello, world!'), '!dlrow ,olleh')} [reverse()]")
    sleep(1.5)
